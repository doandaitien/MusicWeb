...
<body>
    ...
    <div class="info-banner-box">
        <div class="container">
            <div class="blur-container" style="background: url(<?=base_url(); ?>vendor/<?=$img?>) center center / cover no-repeat rgb(112, 89, 75); width: 84%; height: 220px;"></div>
            <div class="row">
                <div <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sub-container">
                    <a class="medium-card-11">
                        <img src="<?=base_url(); ?>vendor/<?=$img?>" alt="" style="width: 160px; height: 160px;">
                    </a>
            ...
            <div class="miniplayer-inner">
                <div class="control-container audioPlayer">
                    ...
                    <div class="info-detail">
                        <div class="song-info">
                        	<span class="songsid" hidden="true"><?=$top10[0]['SID']?></span>
                            <span class="song-name">
                                <a><?=$top10[0]['song_name']?></a>
                            </span>
                            <span class="artist">
                                <a>-<?=$top10[0]['singer']?></a>
                            </span>
                    ...
                    <?php foreach($top10 as $key2 => $value2): ?>
	                    <audio class="audio">
